...
inoremap <buffer> <c-x>be <c-r>=lh#cpp#snippets#_begin_end('begin')<cr>
xnoremap <buffer> <c-x>be <c-\><c-n>ci,<c-r>".begin(),<c-r>".end()
nmap <buffer> <c-x>be viw<c-x>be

" - 'algo(container.rbegin(),container.rend()§)',
inoremap <buffer> <c-x>rbe <c-r>=lh#cpp#snippets#_begin_end('rbegin')<cr>
xnoremap <buffer> <c-x>rbe <c-\><c-n>ci,<c-r>".rbegin(),<c-r>".rend()
nmap <buffer> <c-x>rbe viw<c-x>rbe

" - 'algo(container.cbegin(),container.cend()§)',
inoremap <buffer> <c-x>cbe <c-r>=lh#cpp#snippets#_begin_end('cbegin')<cr>
xnoremap <buffer> <c-x>cbe <c-\><c-n>ci,<c-r>".cbegin(),<c-r>".cend()
